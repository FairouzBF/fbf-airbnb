...
import AirbBnbLogo from '../../../public/assets/logo.png'
                ...
                <div className='mx-8 mt-4 flex-col '>
                    ...
                    <div className='grid grid-cols-2 '>
                        <div className='mr-2'>
                            ...
                            <input className='shadow appearance-none border rounded w-full py-2 px-3 mt-2 text-secondary leading-tight focus:outline-none focus:shadow-outline' value={lastName} type="text" placeholder='NOM' onChange={(e) => setLastName(e.target.value)} /><br />
                        </div>
                        <div className='ml-2'>
                            <label className='block text-secondary text-sm font-bold mt-2' htmlFor="password">PRENOM :</label>
                            <input className='shadow appearance-none border rounded w-full mt-2 py-2 px-3 text-secondary leading-tight focus:outline-none focus:shadow-outline' value={firstName} type="text" placeholder='Prenom' onChange={(e) => setFirstName(e.target.value)} /><br />
                        </div>

                    </div>

                    <label className='block text-secondary text-sm font-bold mt-4' htmlFor="email">EMAIL :</label>
                    <input className='shadow appearance-none border rounded w-full mt-2 p-2 px-3 text-secondary leading-tight focus:outline-none focus:shadow-outline' value={email} type="email" placeholder='adresse@mail.com' onChange={(e) => setEmail(e.target.value)} /><br />

                    <label className='block text-secondary text-sm font-bold mt-6' htmlFor="password">MOT DE PASSE :</label>
                    <input className='shadow appearance-none border rounded w-full mt-2 py-2 px-3 text-secondary leading-tight focus:outline-none focus:shadow-outline' value={password} type="password" placeholder='******' onKeyDown={(e) => e.key === 'Enter' && handleForm()} onChange={(e) => setPasssword(e.target.value)} /><br />

                    <div className='grid grid-cols-2 mt-2'>
                        <div className=''>
                            <label className='block text-secondary text-sm font-bold mt-4' htmlFor="avatar">AVATAR :</label>
                    ...
                    <label className='ml-2'>Je met en ligne mon logement.</label>
