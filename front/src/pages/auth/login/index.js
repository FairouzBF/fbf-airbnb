...
const Index = () => {
    ...
    const handleForm = () => {
        ...
        if (form.email && form.password) {
            ...
            setMessage('Veuillez remplir les champs manquants !')
        }
    }
    return (
                ...
                <div className='mx-8 mt-4 flex-col '>
                    ...
                    <div className='flex justify-between mt-2'>
                        <a className="inline-block align-baseline font-bold text-sm text-primary cursor-pointer hover:text-red-700 pb-2" href="/auth/register">
                            Pas inscrit ? Cliquez ici
                        </a>
                        <a className=" align-baseline font-bold text-sm text-primary cursor-pointer hover:text-red-700 pb-2">
                            Mot de passe oublié ?
                        </a>
                    </div>
                    <div className='flex justify-between mt-6'>
                        <a className="font-bold text-sm text-primary cursor-pointer hover:text-red-700 pb-2" href="/auth/login">
