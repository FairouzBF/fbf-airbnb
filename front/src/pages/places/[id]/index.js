...
const index = () => {
  ...
  if (loading) {
    return <p className='text-2xl font-bold text-center mt-52'>Chargement...</p>;
  }
  if (error) {
          ...
          <div className='mx-auto ' >
            ...
            <div className='flex flex-row justify-between'>
              <div className='flex mt-2'>
                <span className='flex font-semibold'> <Star /> 4 ·</span>
                <span className='font-semibold ml-1 underline cursor-pointer'> 5 commentaires</span>
          ...
          <div className='w-full flex'>
            ...
            <div style={{ width: '60%' }}>
              ...
              <div className='border-b-2 pb-6 mt-8'>
                ...
                <div className='flex flex-col my-4'>
                  <span className='text-lg font-semibold flex'> <CalendarOutline className='mr-2' /> Annulation gratuite.</span>
                </div>
              </div>
